...
dir_path = "Cifar100/"+sys.argv[1]+"*"+sys.argv[2]+"*"+sys.argv[3]+"*"+sys.argv[4]+"*"+sys.argv[5]+"*"+sys.argv[6]+"/"
dir_path2 = "Cifar100/"

# Allocate data to users
def generate_cifar100(dir_path, num_clients, num_classes, niid, balance, partition,class_per_client,alpha):
...
if __name__ == "__main__":
    ...
    generate_cifar100(dir_path, num_clients, num_classes, niid, balance, partition,class_per_client,alpha)