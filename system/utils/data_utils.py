...
def read_data(dataset, idx, args,is_train=True):
    if is_train:
        train_data_dir = os.path.join('../dataset', dataset, args.arv1+"*"+args.arv2+"*"+args.arv3+"*"+args.arv4+"*"+args.arv5+"*"+args.arv6,'train/')
        ...
        test_data_dir = os.path.join('../dataset', dataset, args.arv1+"*"+args.arv2+"*"+args.arv3+"*"+args.arv4+"*"+args.arv5+"*"+args.arv6,'test/')
