from system.flcore.clients.clientreppt import clientREPPT
...
class PFedRepPT(Server):
    def __init__(self, args, times):
        super().__init__(args, times)

        # select slow clients
        self.set_slow_clients()
        self.set_clients(args, clientREPPT)
    ...
    def save_client_model(self):
        ...
        for c_idx,c in enumerate(self.clients):
            model_path_save = os.path.join(model_path, self.algorithm + "_server" +str(c_idx)+ ".pt")
